...
//* header size fix
if(screen.width <= 500){
  document.getElementById('header_img_0').style.height = "32px"
  document.getElementById('header_img_0').style.width = "70px"

  document.getElementById('header_img_1').style.height = "27px"
  document.getElementById('header_img_1').style.width = "100px"

  document.getElementById('header_txt_0').style.fontSize = "19px"
